...
export const Cases=()=>{
    ...
    return <Box>
        ...
        <Box>
            {/* upper side */}
            <Box>
                <Box p={4} fontSize='30px' textAlign={[ 'left']} fontWeight="bold"> Cases</Box>
                    ...
                    <Box style={{display:"flex"}} width="70%">
                        <Box width="30%" marginLeft={10}>
                            ...
                            <InputGroup>
                                ...
                                <Input placeholder="Search by name or Case Status"
                                value={searchQuery}
                        ...
                        <Box marginLeft="10px" display="flex" columnGap="10px">
                            {/* sorting */}
                            <Button backgroundColor="white" border="solid 1px" borderColor="gray">Case Status</Button> 
                            {/* <Button backgroundColor="white" border="solid 1px" borderColor="gray">Location</Button> */}
                            <Button backgroundColor="white" border="solid 1px" borderColor="gray">Assignee</Button>
                        </Box>
                    </Box>
